...
public class Factura {
    ...
    /**
     *  Conjunto de datos asociados a la factura_v1 que garantizar�n la autor�a y la integridad del mensaje. Se define como opcional para facilitar la verificaci�n y el tr�nsito del fichero. No obstante, debe cumplimentarse este bloque de firma electr�nica para que se considere una factura_v1 electr�nica v�lida legalmente frente a terceros.
     *
     * @return
     *     possible object is
     *     {@link SignatureType }
