...
public class ExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    static {
        classNames.put("http://ec.gob.sri.ws.autorizacion^^respuestaComprobante",respuestaComprobante.class);
        classNames.put("http://ec.gob.sri.ws.autorizacion^^autorizacion",autorizacion.class);
        classNames.put("http://ec.gob.sri.ws.autorizacion^^mensaje",mensaje.class);
        classNames.put("http://ec.gob.sri.ws.autorizacion^^respuestaLote",respuestaLote.class);
        classNames.put("http://ec.gob.sri.ws.autorizacion^^respuestaComprobante_autorizaciones",respuestaComprobante_autorizaciones.class);
        classNames.put("http://ec.gob.sri.ws.autorizacion^^autorizacion_mensajes",autorizacion_mensajes.class);
        classNames.put("http://ec.gob.sri.ws.autorizacion^^respuestaLote_autorizaciones",respuestaLote_autorizaciones.class);
    }
