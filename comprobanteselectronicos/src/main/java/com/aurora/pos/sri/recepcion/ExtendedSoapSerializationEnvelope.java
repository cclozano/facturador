...
public class ExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    static {
        classNames.put("http://ec.gob.sri.ws.recepcion^^respuestaSolicitud",respuestaSolicitud.class);
        classNames.put("http://ec.gob.sri.ws.recepcion^^comprobante",comprobante.class);
        classNames.put("http://ec.gob.sri.ws.recepcion^^mensaje",mensaje.class);
        classNames.put("http://ec.gob.sri.ws.recepcion^^respuestaSolicitud_comprobantes",respuestaSolicitud_comprobantes.class);
        classNames.put("http://ec.gob.sri.ws.recepcion^^comprobante_mensajes",comprobante_mensajes.class);
    }
