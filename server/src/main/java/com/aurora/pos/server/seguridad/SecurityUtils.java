...
public class SecurityUtils {
	 ...
	 *         otherwise
	 */
	public static boolean isCurrentUserInRol(String rol) {
		return getUserRoles().stream().filter(roleName -> roleName.equals(Objects.requireNonNull(rol))).findAny()
				.isPresent();
	}
	 ...
	 */
	public static Usuario getCurrentUser(UserServiceImp userService) {
		Usuario user = userService.findByEmail(SecurityUtils.getUsername());
		return user;
	}
}
