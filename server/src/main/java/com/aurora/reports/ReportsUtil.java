...
public class ReportsUtil {
    ...
    public StreamResource prepareForExportReport(String reportTemplate, String reportFileName,
                                                 ReportGenerator.Formato formato, Collection dataSource, Map datosReporte){
     ...
     * @param templatePath Report templates path
    ...
    private StreamResource createResource(final String templatePath,
                                          ...
                                          ReportGenerator.Formato formato,
    ...
    private StreamResource createXResource(final String templatePath, ReportGenerator.Formato formato, JRBeanCollectionDataSource dataSource, Map datosReporte) {
