...
public class ReportGenerator {
    ...
    /**
     * Load the templates (defined by templatePath) and return a JasperDesign object representing the templates
     * @return JasperDesign
     */
    private JasperDesign loadTemplate(String templatePath){
        ...
        if(templateFile.exists()){
            try {
                ...
                log.error("Error in loading the templates... "+e.getMessage());
            }
        }
        else
